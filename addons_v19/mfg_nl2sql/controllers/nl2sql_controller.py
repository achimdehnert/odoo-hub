...
- Antworte NUR mit dem SQL-Statement, nichts anderes"""
    ...
    @http.route('/mfg_nl2sql/query', type='jsonrpc', auth='user', methods=['POST'])
    ...
    @http.route('/mfg_nl2sql/dashboard_data', type='jsonrpc', auth='user',
                methods=['POST'])
    ...
    @http.route('/mfg_nl2sql/schema', type='jsonrpc', auth='user',
                methods=['POST'])
    ...
    @http.route('/mfg_nl2sql/history', type='jsonrpc', auth='user',
                methods=['POST'])
    ...
    @http.route('/mfg_nl2sql/schema_meta', type='jsonrpc', auth='user', methods=['POST'])
    ...
    @http.route('/mfg_nl2sql/history/<int:history_id>/result', type='jsonrpc',
